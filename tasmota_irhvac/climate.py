...
class TasmotaIrhvac(ClimateDevice, RestoreEntity):
    ...
    def __init__(
        ...
        self._swing_vertical = next(iter(swing_list[SWING_VERTICAL]), SWING_OFF)
        self._swing_horizontal = next(iter(swing_list[SWING_HORIZONTAL]), SWING_OFF)
    ...
    def swing_modes(self):
        ...
        if SWING_VERTICAL_OFF in swing_vertical and SWING_HORIZONTAL_OFF in swing_horizontal:
            swing_list.append(SWING_OFF)
        if SWING_VERTICAL_AUTO in swing_vertical and SWING_HORIZONTAL_AUTO in swing_horizontal:
    ...
    async def async_set_swing_mode(self, swing_mode):
        ...
        if SWING_VERTICAL in self._swing_mode: 
            ...
            if self._swing_mode == SWING_BOTH:
                self._swing_vertical = SWING_VERTICAL_AUTO
                self._swing_horizontal = SWING_HORIZONTAL_AUTO
            elif self._swing_list[SWING_VERTICAL] and self._swing_list[SWING_HORIZONTAL] and self._swing_mode == SWING_OFF:
                self._swing_vertical = SWING_VERTICAL_OFF
                self._swing_horizontal = SWING_HORIZONTAL_OFF
            else:
